...
if menu == "الصفحة الرئيسية":
  ...
  st.write(
      "لوحة المؤشرات والداشبورد مهيأة بالكامل بجدول مبسط من عمودين و6 صفوف واضحة"
      " (البيان - الرقم)."
  )
...
# ==================== 4. استعراض البيانات والداشبورد ====================
  ...
  if os.path.exists(EXCEL_FILE):
    ...
    # لو سجل الأطفال، نعرض جدول مؤشرات الأداء المبسط (عمودين و 6 صفوف واضحة)
    if sheet_to_show == "سجل المشورة للاطفال":
      ...
      # عرض الجدول مع ضمان إظهار أسماء الأعمدة بوضوح
